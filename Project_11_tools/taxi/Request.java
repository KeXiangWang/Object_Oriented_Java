...
public class Request implements Runnable {
	 ...
	 * @EFFECTS: normal_behavior: print the wrong information. this.taxiList == new
	 *           ArrayList<>(); this.taxiMap == taxiMap; this.printWriter == new
	 *           PrintWriter(new BufferedWriter(new FileWriter("request" + ID +
	 *           ".txt")), true); exception_behavior(Exception e): print the wrong
	 *           information.
	 * 
	 */
	 ...
	 * @REQUIRES: None;
	 * @MODIFIES: this.taxiList;
	 * @EFFECTS: normal_behavior: Pick a nearest accessible taxi, which has the most

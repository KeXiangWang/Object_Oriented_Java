...
public class TaxiMap {
	 ...
	 * @EFFECTS: taxiHere = new ArrayList[TaxiSys.SQUARESIZE]; pointMap = new
	 *           Point[TaxiSys.SQUARESIZE]; (\all int i; 0<=i<TaxiSys.SQUARESIZE;
	 *           pointMap[i] != null); (\all int i; 0<=i<TaxiSys.SQUARESIZE;
	 *           taxiHere[i] != null);
	 */

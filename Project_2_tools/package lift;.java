...
//				System.out.println("#Invalid Request ("+queue.frontRq().getGt()+","+queue.frontRq().getAf()+","+queue.frontRq().getDr()+","+queue.frontRq().getTime()+")");
				System.out.println("#Invalid Request");
			else
//				System.out.println("#Invalid Request ("+queue.frontRq().getGt()+","+queue.frontRq().getTg()+","+queue.frontRq().getTime()+")");
				System.out.println("#Invalid Request");
			queue.moveFront(1);
		}
		rq= queue.frontRq();

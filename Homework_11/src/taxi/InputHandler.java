...
public class InputHandler implements Runnable {
	 ...
	 * @EFFECTS: this.requestQueue.size()>=\old(this.requestQueue.size()); str is a
	...
	/**
	 * @MODIFIES:
	 * @EFFECTS: print the taxi information; str is a valid check request ==> the
	 *           road'status changed ==> \result=true; str is not a valid setRoad
		...
		try {
			if (str.matches("^%\\d+$")) {
				...
				if (biterator == null) {
					...
					System.out.println("hasNext: " + biterator.hasNext());
				}
				...
				if (biterator == null) {
					...
					System.out.println("hasPrevious: " + biterator.hasPrevious());
				}

...
public class FileLoader {
	 ...
	 * @EFFECTS: initTaxiList.size()>=\old(initTaxiList.size());
	 ...
	 * @EFFECTS: initFlowList.size()>=\old(initFlowList.size());
	 */
	 ...
	 * @EFFECTS: requestQueue.size()>=\old(requestQueue.size());
	 */

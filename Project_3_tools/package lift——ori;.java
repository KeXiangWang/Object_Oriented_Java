...
//		System.out.println(temClock+rq.toString());
...
//			System.out.println(toString(rq));
			System.out.println("main:"+toString(rq));
			clock++;
...
//					System.out.println(toString(lastRq2));
					System.out.println("why? las1:"+toString(lastRq)+"456 5555"+toString(rq));
					System.out.println("why? las2:"+toString(lastRq2));
					last2=0;
					lastRq=rq;
					last=1;
				}
					...
					act(lastRq);
//					System.out.println(toString(lastRq));
					System.out.println("why? las1:"+toString(lastRq)+"456 6666"+toString(rq));
					lastRq=rq;
					last=1;
				}
				clock++;
...
//						System.out.println(toString(rq));
						System.out.println("main:"+toString(rq));
						System.out.println("las1:"+toString(lastRq));
						System.out.println("las2:"+toString(lastRq2));
...
//						System.out.println(toString(rq));
//						System.out.println(toString(lastRq));
						System.out.println("main9999999999:"+toString(rq));
						System.out.println("las1:"+toString(lastRq));
					} else {
						act(lastRq);
//						System.out.println(toString(lastRq));
//						System.out.println(toString(rq));
						System.out.println("las1:"+toString(lastRq));
						System.out.println("main456:"+toString(rq));
					}
					clock++;
					last=0;
				}else {
...
//					System.out.println(toString(lastRq));
					...
					act(rq);
//					System.out.println(toString(rq));
					System.out.println("main789:"+toString(rq));
					clock++;
					last=0;
				}
